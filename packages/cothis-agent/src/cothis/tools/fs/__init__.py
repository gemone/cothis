...
Holds the read/list/search/create/modify/edit/delete tools. The subpackage
...
- ``fs.edit`` — unique-anchor string replace.
...
from cothis.tools.fs.edit import _edit as fs_edit
...
__all__ = ["read", "fs_list", "fs_search", "fs_create", "fs_modify", "fs_edit", "fs_delete"]
